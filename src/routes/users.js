...
import {authenticateJWT, isAdmin, isUserOrAdmin } from "../middlewares/authentication.js";
...
router.put("/:id", authenticateJWT, isUserOrAdmin, async (req, res) => {
...
router.delete("/:id", authenticateJWT, isUserOrAdmin, async (req, res) => {
    const userId = req.params.id;
